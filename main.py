...
def help_command(message):
    if ensure_joined(message):
        help_text = (
            ...
            "• Ensure there is little background noise.\n"
            "• Speak clearly and close to the microphone.\n"
            "• Select the correct language before sending the file.\n\n"
            "**2. How to clean raw transcription:**\n"
            "The bot provides raw speech-to-text. To make it perfect, copy the text and ask ChatGPT:\n"
